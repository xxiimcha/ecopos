...
namespace EcoPOSv2
{
    public partial class Terminal : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                terminal_report.SetParameterValue("Deductions", "0.00");
        ...
        private void BtnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            workerExportProcessor.RunWorkerCompleted += WorkerExportProcessor_RunWorkerCompleted;
            workerExportProcessor.RunWorkerAsync();
        }

        private void WorkerExportProcessor_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            MessageBox.Show("Export report success", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            return;
        }
        ...
        private void WorkerExportProcessor_DoWork(object sender, DoWorkEventArgs e)
        {
            Invoke(new MethodInvoker(delegate ()
            {
                if(cbxSales.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "SalesReport");
                ...
                if(cbxStaffSales.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "StaffSalesReport");
                }
                ...
                if (cbxRetailSales.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "RetailSalesReport");
                ...
                if (cbxWholesaleSales.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "WholeSalesReport");
                ...
                if (cbxVoidItems.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "VoidItemsReport");
                ...
                if (cbxVoidTransactions.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "VoidTransactionReport");
                ...
                if (cbxRegularDiscounts.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "RegularDiscountsReport");
                ...
                if (cbxSpecialDiscounts.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "SpecialDiscountReport");
                ...
                if (cbxPaymentMethod.Checked == true)
                {
                    ...
                    EI.ExportDgvToExcel(dt, "PaymentMethodReport");
                ...
                if (cbxItemsSold.Checked == true)
                {
                    ...
                    if (cmbTerminalNames.Text == "All terminals")
                    {
                        psql.Query(@"SELECT DISTINCT ti.description as 'DESCRIPTION', 
                                            (SELECT p.rp_inclusive FROM products as p WHERE p.description = ti.description) as 'RETAIL AMOUNT' , 
                                            ...
                                            FROM transaction_details as td INNER JOIN transaction_items as ti ON td.order_ref = ti.order_ref
                                            WHERE td.date_time BETWEEN '" + dtpFrom.Value + "' AND '" + dtpTo.Value + @"' AND selling_price_inclusive > 0
                                            GROUP BY ti.description ORDER BY 3 DESC");
                    }
                    else
                    {
                        psql.Query(@"SELECT DISTINCT ti.description as 'DESCRIPTION', 
                    ...
                    EI.ExportDgvToExcel(dt, "ItemSoldReport");
                ...
                if (cbxProfit.Checked == true)
                {
                    ...
                    if (cmbTerminalNames.Text == "All terminals")
                    {
                        psql.Query(@"select Sales,Total_Cost,Gross,date from profit where date between '" + dtpFrom.Value + "' and '" + dtpTo.Value + "' ORDER BY date,terminal_id ASC");
                    }
                    else
                    {
                        psql.Query(@"select Sales,Total_Cost,Gross,date from profit where terminal_id=" + cmbTerminalNames.Text + " AND date between '" + dtpFrom.Value + "' and '" + dtpTo.Value + "' ORDER BY date,terminal_id ASC");
                    }
                    dt.DataSource = psql.DBDT;

                    EI.ExportDgvToExcel(dt, "ProfitReport");
