...
namespace EcoPOSv2
{
    public partial class AInventory : Form
    {
        ...
        private void WorkerSearchInventory_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            workerSQL.Query(@"SELECT p.productID, p.description as 'Item', c.name as 'Category', w.name as 'Warehouse', i.stock_qty as 'Stock',p.cost as 'Cost', p.rp_inclusive as 'Retail', p.wp_inclusive as 'Wholesale' FROM products as p
        ...
        private void txtSearch_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            SQL.Query(@"SELECT p.productID, p.description as 'Item', c.name as 'Category', w.name as 'Warehouse', i.stock_qty as 'Stock',p.cost as 'Cost', p.rp_inclusive as 'Retail', p.wp_inclusive as 'Wholesale' FROM products as p
                       INNER JOIN warehouse as w ON
                       p.warehouseID = w.warehouseID
                       INNER JOIN product_category as c ON
                       p.categoryID = c.categoryID 
