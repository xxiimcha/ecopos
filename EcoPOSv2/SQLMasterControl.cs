...
namespace EcoPOSMasterControl
{
    class SQLMasterControl
    {
        ...
        public static string constring = @"Data Source=.; user=" + dbuser + "; password=" + dbpass + ";";
        ...
        public SQLMasterControl()
        {
        }

        // ALLOW CONNECTION STRING OVERRIDE
        public SQLMasterControl(string ConnectionString)
        {
