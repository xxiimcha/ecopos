    ...
    public partial class Payment : Form
    {
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            SQL.Query(@"INSERT INTO transaction_details 
                       ...
                       less_vat, vatable_sale, vat_12, vat_exempt_sale, zero_rated_sale, userID, user_first_name,terminal_id) 
                       ...
                       @zero_rated_sale, @userID, @user_first_name,@terminal_id FROM order_no WHERE terminal_id=@terminal_id AND order_ref = (SELECT MAX(order_ref) FROM order_no where terminal_id=@terminal_id)");
            if (SQL.HasException(true))
            {
                MessageBox.Show("1");
                return;
